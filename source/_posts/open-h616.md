...
# LCPI H616 ZERO开发板教程 · 系统烧录+环境配置+常见问题解决
...
- 闲置收益：可利用闲置算力参与 CPU 友好型加密货币挖矿，让开发板在闲置时也能产生收益。

> 🔗 算力利用配套方案：如果你想利用开发板或家用电脑的闲置 CPU 算力挖矿，可使用【Kryptex Miner V5】，支持门罗币等 CPU 友好型币种，操作简单、收益稳定，挖矿所得可直接提现至多平台（加密货币）账户一站式管理。
> Kryptex 专属注册链接：
